...
class CollageScreenTwo extends StatefulWidget {
  const CollageScreenTwo({Key? key, required this.imagePaths}) : super(key: key);

  final List<File> imagePaths;

  @override
  _CollageScreenTwoState createState() => _CollageScreenTwoState();
}

class _CollageScreenTwoState extends State<CollageScreenTwo> {
